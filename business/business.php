...
class Business
{
	...
	public static function GetModulesByCategory($category, $pageNo, &$rHowManyPages)
	{
		// Query that returns the number of modules
		$sql = 'CALL count_modules_in_collection_by_category(:category)';
		...
		// Build SQL query
		$sql = 'CALL get_modules_by_category(:category, :modules_per_page, :start_item)';

		// Build the parameters array

		$params = array (':category' => $category, ':modules_per_page' => MODULES_PER_PAGE, ':start_item' => $start_item);
	...
	// Search the collection
	public static function GetModulesByCategorySearch($searchString, $category, $pageNo, &$rHowManyPages)
	{
		// Count the number of search results
		$sql = 'CALL count_search_category_result(:search_string, :category)';

		$params = array(':search_string' => $searchString, ':category' => $category);
		...
		// Retrieve the list of matching modules
		$sql = 'CALL search_category(:search_string, :category, :modules_per_page, :start_item)';

		// Build the parameters array
		$params = array (':search_string' => $searchString, ':category' => $category, ':modules_per_page' => MODULES_PER_PAGE, ':start_item' => $start_item);
	...
	// Search the collection
	public static function GetModulesByCategoryKeyword($keyword, $category, $pageNo, &$rHowManyPages)
	{
		// Count the number of search results
		$sql = 'CALL count_keyword_category_result(:keyword, :category)';

		$params = array(':category' => $category, ':keyword' => $keyword);
		...
		// Retrieve the list of matching modules
		$sql = 'CALL get_modules_by_keyword_category(:keyword, :category, :modules_per_page, :start_item)';

		// Build the parameters array
		$params = array (':category' => $category, ':keyword' => $keyword, ':modules_per_page' => MODULES_PER_PAGE, ':start_item' => $start_item);
  ...
  // Add a module
  public static function AddModule($moduleTitle, $moduleLeader, $moduleDescription, $image, $category)
  {
    // Build the SQL query
    $sql = 'CALL add_module(:module_title, :module_leader, :module_description, :image, :category)';
  ...
  {
    // Build the SQL query
    $sql = 'CALL update_module(:module_id, :module_title, :module_leader, :module_description, :image, :category)';
